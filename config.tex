...
\def\elementAA{\textbf{\author} \\ k11736476}

\def\elementB{Submission / Angefertigt am}
\def\elementBB{\textbf{Institute for Software Systems Engineering}}

\def\elementC{Thesis Supervisor / First Supervisor / BeurteilerIn / ErstbeurteilerIn / ErstbetreuerIn}
\def\elementCC{a.~Univ.-Prof.~Dr.\@ \textbf{Paul Grünbacher}}
...
\def\date{Month Year / Monat Jahr}
...
\def\title{RELEASE AUTOMATION AND TEST INFRASTRUCTURE INTEGRATION}
...
\def\study{Intelligent Information Systems}
