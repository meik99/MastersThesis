...
Chapter~\ref{ch:implementation} shows how the problems described are solved, using one system, called the Dynamic Testing Framework (DTF) to generate a pipeline for tests, and using a second pipeline, simply called a release pipeline, to generate releases.
