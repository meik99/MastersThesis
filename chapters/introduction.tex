...
In order to answer \italic{Q1}, a system is developed to help abstract the complexity of maintaining higher level tests.
...
%% TODO: discuss the two papers about similarity based variability testing