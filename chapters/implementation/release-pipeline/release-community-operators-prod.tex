...
In this forked repository, the folder `${fork_name}/operators/dynatrace-operator/${version}/` is created for the new version.
The Dockerfile located at `{repository}/config/olm/kubernetes/bundle-${version}.Dockerfile` is placed in the version's folder.
The previously mentioned folder is then populated with the folders `{repository}/config/olm/kubernetes/${version}/manifests` and `{repository}/config/olm/kubernetes/${version}/metadata`.
...
| ------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | ----------------------------------------------------- | ----------------------------------------------------- |
| `redhat_community_operators_prod_repository`      | Defines the repository that should be forked. I.e., defines the value of `{original-repository}`     | `redhat-openshift-ecosystem/community-operators-prod` | `redhat-openshift-ecosystem/community-operators-prod` |
| `redhat_community_operators_prod_repository_fork` | Defines the name the forked repository should have. I.e., defines the value of `{forked-repository}` | `dt-team-kubernetes/community-operators-prod`         | `dt-team-kubernetes/community-operators-prod`         |
