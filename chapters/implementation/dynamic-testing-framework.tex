...
The properties \textbf{exclusivity} and \textbf{dependency} are planned to be used with tests that should either not run on the same cluster or that can run on the same cluster.
